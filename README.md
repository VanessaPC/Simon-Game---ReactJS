...
# Simon Game 
The normal Simon Game, replicated on React JS, HTML5 and CSS3. 

For a quick look at the application and code, click on the link below: 
[Simon Game on CodePen](https://codepen.io/Lunnaris/full/NvQBJQ/)
